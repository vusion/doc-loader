...
module.exports = function (content) {
    ...
    const vendors = _.getMaterials(vendorsPath, config.docs && config.docs.vendors, 'vendors');
    ...
    const $docs = Object.assign({}, defaults, config.docs, {
        componentsGroups: _.groupMaterials(components),
        vendorsGroups: _.groupMaterials(vendors),
