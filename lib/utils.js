...
exports.renderRoutes = function (routes) {
    return '[\n' + routes.map((route) => {
        ...
        route.fullPath && properties.push(`component: require('${route.fullPath.replace(/\\/g, '/')}').default`);
...
exports.getMaterials = function (basePath, materials, type) {
    ...
    materials.forEach((material) => {
        if (material.path) {
            ...
            material.path = path.resolve(basePath, material.name + (type === 'components' ? '.vue/README.md' : '/README.md')).replace(/\\/g, '/');
        ...
        if (material.path) {
            ...
            if (path.isAbsolute(material.path) && !fs.existsSync(material.path)) {
                ...
                const depMarkdownPath = path.resolve(basePath, `../../node_modules/proto-ui.vusion/src/${type}/` + material.name + (type === 'components' ? '.vue/README.md' : '/README.md')).replace(/\\/g, '/');
