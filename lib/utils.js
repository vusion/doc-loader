...
exports.getMaterials = function (basePath, materials, type) {
    if (!materials) { // 如果配置中没有 materials，则根据目录来生成
        if (type === 'components' || type === 'vendor') {
            const materialsMap = {};
    ...
    materials.forEach((material) => {
        const relativeReadmePath = (material.scope ? `@${material.scope}/` : '') + material.name + (type === 'components' || type === 'vendor' ? '.vue/README.md' : '/README.md');
