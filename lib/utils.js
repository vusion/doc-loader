...
exports.nestRoutes = function (flatRoutes) {
    ...
    const parse = function (route) {
        ...
        if (!parent) {
            ...
            parent.fullPath = parent.filePath = path.resolve(__dirname, '../layouts/wrapper.vue');
            parse(parent);
        }
...
exports.getComponents = function (basePath, components) {
    if (!components) {
        ...
        components = Object.keys(componentsMap).map((vueName) => {
            const component = componentsMap[vueName];
