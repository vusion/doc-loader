    ...
    materials.forEach((material) => {
        ...
        if (material.path) {
            ...
            if (path.isAbsolute(material.path) && !fs.existsSync(material.path)) {
                ...
                const depMarkdownPath = path.resolve(process.cwd(), 'node_modules/proto-ui.vusion/src/components/' + material.name + (type === 'components' ? '.vue/README.md' : '/README.md')).replace(/\\/g, '/');
